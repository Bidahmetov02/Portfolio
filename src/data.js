  ...
  export const skills = [
    {
      id: 1,
      title: "Languages",
      list: ["JavaScript", "Python", "C#", "HTML", "CSS"]
    },
    {
      id: 2,
      title: "Frameworks/Libraries",
      list: ["Aiogram", "Django", "Django Rest Framework", "ASP .NET", "React"]
    },
    {
      id: 3,
      title: "Tools",
      list: ["Oracle Virtual Box", "Photoshop", "Visual Studio", "Azure DevOps", "Git"]
    },
  ]